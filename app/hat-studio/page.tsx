...
export default function Page() {
  ...
  return (
    <main className="min-h-screen py-24 px-4 bg-[#FDF9F3] text-center transition-all duration-300">
      ...
      {/* Decorative Background with Floating Kites and Clouds */}
<style jsx>{`
  /* --- Animations --- */
  ...
  .kite-left {
    animation: floatKiteLeft 6s ease-in-out infinite;
  }

  .kite-right {
    animation: floatKiteRight 8s ease-in-out infinite;
  }

  .cloud-left {
    animation: moveCloudLeft 30s ease-in-out infinite;
  }

  .cloud-right {
    animation: moveCloudRight 35s ease-in-out infinite;
  }
`}</style>
...
<img
  ...
  alt="Cloud Left"
  className="absolute top-10 left-10 w-40 opacity-20 pointer-events-none select-none cloud-left"
/>
<img
  src="/images/cloud2.png"
  alt="Cloud Right"
  className="absolute top-20 right-10 w-48 opacity-25 pointer-events-none select-none cloud-right"
/>

{/* Kites */}
<svg
  className="absolute top-16 left-[-50px] w-40 h-40 opacity-90 pointer-events-none kite-left"
  viewBox="0 0 200 200"
  xmlns="http://www.w3.org/2000/svg"
>
  <polygon points="100,10 150,100 100,190 50,100" fill="#B17C4A" stroke="#4C3A2F" strokeWidth="3" />
  <path d="M60 160 C40 200, 80 240, 50 280" stroke="#4C3A2F" strokeWidth="2" fill="none" />
</svg>

<svg
  className="absolute top-[80px] right-[-60px] w-36 h-36 opacity-90 pointer-events-none kite-right"
  viewBox="0 0 200 200"
  xmlns="http://www.w3.org/2000/svg"
>
  <polygon points="100,10 150,100 100,190 50,100" fill="#333" stroke="#1a1a1a" strokeWidth="3" />
  <path d="M140 160 C160 200, 120 240, 150 280" stroke="#1a1a1a" strokeWidth="2" fill="none" />
</svg>
    </main>
  );
}
