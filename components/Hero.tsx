...
export default function Hero() {
  return (
    <section className="pt-28 hero-bg relative">
      ...
      {/* Kites */}
      <img src="/images/kite.png" alt="" className="kite absolute left-6 md:left-12 top-40 w-20" />
      <img src="/images/kite.png" alt="" className="kite absolute right-6 md:right-12 top-40 w-20 [animation-duration:9s]" />
