...
export default function FramePage() {
  const embeds = [
    ...
    `<blockquote class="twitter-tweet"><p lang="en" dir="ltr">The first AI-focused Layer 1 comes to Avalanche - <a href="https://twitter.com/GoKiteAI?ref_src=twsrc%5Etfw">@GoKiteAI</a><br><br>It&#39;s a next-gen blockchain designed exclusively for decentralized AI development.<br><br>Built on Avalanche for AI, Kite AI fuses compute, data and intelligence into a scalable Layer 1 network.<br><br>It enables transparent… <a href="https://t.co/V5LuO8X48Z">https://t.co/V5LuO8X48Z</a> <a href="https://t.co/eBOLjLjtVU">pic.twitter.com/eBOLjLjtVU</a></p>&mdash; hottiebabegem Ⓜ️Ⓜ️T (@HottieBabeGem) <a href="https://twitter.com/HottieBabeGem/status/1975202213195845767?ref_src=twsrc%5Etfw">October 6, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>`,
    `<blockquote class="twitter-tweet"><p lang="en" dir="ltr">unveiling <a href="https://twitter.com/GoKiteAI?ref_src=twsrc%5Etfw">@GoKiteAI</a> ‘s new DeFi hub! 🪁<br><br>we got a new shiny home for users to: <br>1️⃣ claim KITE test tokens<br>2️⃣ track on-chain activity <br>3️⃣ create multisig wallets<br>4️⃣ swap tokens<br>5️⃣ bridge across chains<br><br>finally a unified, seamless site for users to onboard onto kite chain<br><br>check it… <a href="https://t.co/tbTP86WP0S">pic.twitter.com/tbTP86WP0S</a></p>&mdash; Henry Lee (@Henryleemr) <a href="https://twitter.com/Henryleemr/status/1980831899317854593?ref_src=twsrc%5Etfw">October 22, 2025</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>`,
    ``,
    ``,
    ``,
    ``,
